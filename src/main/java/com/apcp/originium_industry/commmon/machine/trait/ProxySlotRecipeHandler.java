...
public final class ProxySlotRecipeHandler {
    ...
    @Getter
    public final List<RecipeHandlerList> proxySlotHandlers;

    public ProxySlotRecipeHandler(SuperMEPatternBufferProxyPart machine, int slots) {
    ...
    public void updateProxy(SuperMEPatternBufferPart patternBuffer) {
    ...
    public static class ProxyRHL extends RecipeHandlerList {
        ...
        public ProxyRHL(SuperMEPatternBufferProxyPart machine) {
            super(IO.IN);
        ...
        public void setBuffer(SuperMEPatternBufferPart buffer, InternalSlotRecipeHandler.SlotRHL slotRHL) {
